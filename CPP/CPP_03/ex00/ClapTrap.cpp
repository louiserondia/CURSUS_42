...
/*   Updated: 2022/12/08 19:08:41 by lrondia          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(string name) : _name(name), _hitPoints(10), _energyPoints(10), _attackDamage(10)	{
...
ClapTrap::~ClapTrap(void)	{
	cout << _name << "'s destructor called" << endl;
}
...
void	ClapTrap::beRepaired(unsigned int amount)	{
	...
	if (i == amount)
		cout << "ClapTrap " << _name << " is being repaired. It recovers "
			 << i << " hit point(s)! (" << _hitPoints << " left)" << endl;
}
